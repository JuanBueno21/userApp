      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget> [
            ...
            const Divider(thickness: 2.0, indent: 10.0, endIndent: 10,
            ),
            ...
            const Row(
              children: [
                ...
                Text(" ADDRESS INFORMATION:", style: TextStyle(fontWeight: FontWeight.bold),),
              ],
            ),
            ...
            Row(
              children: [
                const Text("Zipcode: ", style: TextStyle(fontWeight: FontWeight.bold),
                ),
            ...
            Row(
              children: [
                const Text("Suite: ", style: TextStyle(fontWeight: FontWeight.bold),),
            ...
            const Row(
              children: [
                ...
                Text(" COMPANY INFO:", style: TextStyle(fontWeight: FontWeight.bold),),
              ],
            ),
            ...
            Row(
              children: [
                const Text("Catch Phrase: ", style: TextStyle(fontWeight: FontWeight.bold),),
